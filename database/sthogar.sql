CREATE DATABASE IF NOT EXISTS sthogar_servicios CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
INSERT INTO tecnicos (usuario_id, telefono, direccion, especialidad, fecha_ingreso, notas) VALUES
(2, '55-1000-2000', 'Av. Reforma 123, CDMX', 'CCTV', '2022-04-10', 'Especialista en CCTV residencial.'),
(3, '55-3000-4000', 'Calle Norte 456, CDMX', 'RED', '2023-01-18', 'Soporte en redes y cableado estructurado.');
